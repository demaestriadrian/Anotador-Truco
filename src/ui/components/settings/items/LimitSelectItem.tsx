...
const LimitSelectItem = () => (
    <SettingsRow
        icon={Target}
        label="Partida a"
        hint="Puntos para ganar"
        // Tocar la fila avanza al límite siguiente (con dos, es alternar 15↔30).
        onActivate={() => cambiarLimite(nextOption(LIMITES_VALIDOS, gameState.limit))}
    >
