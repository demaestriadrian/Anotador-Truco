...
export const allMatchsticks = [...document.querySelectorAll('.matchstick')].map(e => e instanceof HTMLElement && new MatchStick(e, sections)).filter(e => e !== null) as MatchStick[]
