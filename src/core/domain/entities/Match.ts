...
export class Match {
    private _teamA: Team;
    private _teamB: Team;
    private _limit: number; // 15 or 30
    ...
    addPoints(teamId: string, points: number): void {
        ...
        // Check if adding points would exceed limit (optional rule, but good to have a check)
        // Truco rules usually allows overshooting, but game ends.
